...
const Search = ({ placeholder = 'write your plant' }: { placeholder?: string }) => {
        ...
        >
            <Flex alignItems="center">
                <input
                    ...
                    type="text"
                />
                <Button className={Module.searchButton} variant="default" onClick={handleSubmit}>
                    <AiOutlineSearch />
                </Button>
            </Flex>
        </form>
...
const Profile = ({ isLoggedIn = false, userName = '' }: { isLoggedIn?: boolean; userName?: string }) => {
    const navi = useNavigate();
    function HandleNavi() {
        navi(`/auth`);
    }
